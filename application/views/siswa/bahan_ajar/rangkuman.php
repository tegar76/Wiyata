    ...
    <?php include("rangkuman_js.php"); ?>


        <div class="none mt-3 mb-5 mr-4">
            <div class="h4 text-right"> <a href="<?= base_url('Siswa/Materi')?>" style="text-decoration: none;">Ruang Materi /</a> Bab <?= $get_rangkuman->bab_ke ?> Rangkuman</div>
        </div>
