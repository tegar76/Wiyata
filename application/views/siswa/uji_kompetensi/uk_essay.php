...
<head>
	...
	<title><?= $title ?></title>
	<link rel="icon" type="image/png" href="<?= base_url() ?>assets/guru/img/iconMiniNo.png" />

	<link rel="stylesheet" href="<?= base_url() ?>assets/siswa/bootstrap/css/latihan.css" />

	<!-- View pdf -->
	<link rel="stylesheet" href="<?= base_url("assets/pdfjs-2.12.313-legacy-dist") ?>/web/viewer_evaluasi.css">
...
<body>
	...
	<div id="outerContainer" class="justify-content-center">
                ...
                <div class="justify-content-center">
					<form action="" class="pl-4">
						<div class="form-group">
							<label for="update_file">Pilih File Evaluasi</label>
